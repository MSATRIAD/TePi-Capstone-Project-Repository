...
app.get('/products', async (req, res) => {
    try {
      ...
      // Menggunakan forEach untuk mengiterasi setiap child (product_1, product_2, dst)
      snapshot.forEach((childSnapshot) => {
        // childSnapshot.key akan mengambil product_1, product_2, dst
        const productId = childSnapshot.key;
        const productData = childSnapshot.val();
        
        products.push({
          id: productId,  // Ini akan berisi "product_1", "product_2", dst
  ...
  app.get('/products/:id', async (req, res) => {
    try {
      // req.params.id akan berisi "product_1" atau "product_2" dst
